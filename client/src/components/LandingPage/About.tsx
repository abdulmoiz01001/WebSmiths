...
const About = () => {
  return (
    <div className=" min-h-screen flex flex-row lg:flex-row justify-between items-center lg:px-32 px-5 pt-24 lg:pt-16 gap-5">
      ...
      <div className=" w-full lg:w-3/4">
        <img className=" rounded-lg" src={'https://th.bing.com/th/id/OIP.hix62Jg09I0_VQW2jmpClwHaEK?w=333&h=187&c=7&r=0&o=5&pid=1.7'} alt="img" />
      </div>
    </div>
  );
};
